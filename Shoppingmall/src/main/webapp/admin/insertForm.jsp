...
<script type="text/javascript">
	$(function () {
		...
		$('#insertItemCheck').click(function() {
			...
			} else if(document.insertForm.item_category.value == "") {
				alert("[상품분류_대분류]를 입력하세요.");
				document.insertForm.item_category.focus();
			} else if(document.insertForm.item_detail_category.value == "") {
				alert("[상품분류_소분류]를 입력하세요.");
				document.insertForm.item_detail_category.focus();
...
<legend>상품 등록</legend>
	<table id="inserttable" >
		...
		<tr>
			...
			<td>대분류 : <span id="cate1" ><input type="text" name="item_category"></span></td>
			<td>소분류 : <span id="cate2" ><input type="text" name="item_detail_category"></span></td>
		</tr>
		<tr>
