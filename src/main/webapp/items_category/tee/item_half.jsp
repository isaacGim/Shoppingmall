...
<body>
    ...
    <div class="detail_category">
        <a href="" class="it">긴팔</a>
	 	<a href="" class="it">반팔</a>
	 	<a href="" class="it">카라</a>
	 	<a href="" class="it">롱/루즈핏</a>
	 	<a href="" class="it">민소매</a>
	 	<a href="" class="it">니트</a>
	 	<a href="" class="it">슬림/베이직핏</a>
	 	<a href="" class="it">후드</a>
