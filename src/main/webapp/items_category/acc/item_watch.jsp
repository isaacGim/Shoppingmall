...
<body>
    ...
    <div class="detail_category">
        <a href="" class="it">팔찌</a>
	 	<a href="" class="it">양말</a>
	 	<a href="" class="it">모자</a>
	 	<a href="" class="it">시계</a>
	 	<a href="" class="it">장갑/워머</a>
	 	<a href="" class="it">지갑</a>
	 	<a href="" class="it">안경</a>
	 	<a href="" class="it">기타</a>
	 	<a href="" class="it">목걸이</a>
	 	<a href="" class="it">머플러</a>
	 	<a href="" class="it">반지</a>
	 	<a href="" class="it">벨트</a>
